...
import { FolderUp, Lock, UploadCloud } from 'lucide-react'
...
export default function DragDropZone({
  ...
  // le bandeau de sécurité et les pastilles de formats, plutôt que
  // d'ajouter une prop dédiée que chaque appelant devrait connaître.
  ...
  return (
    <div className="flex flex-col items-center">
      {!isCompact && (
        <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 shadow-sm dark:text-emerald-400">
          <Lock size={12} aria-hidden="true" />
          {t('common.dropzoneSecurityBadge')}
        </span>
      )}
